...
     return api.sendMessage("Muri khai khaba☹️😒", threadID);
   };
  
...
   if ((event.body.toLowerCase() == "Pocha Chera") || (event.body.toLowerCase() == "pocha chera")) {
     return api.sendMessage("Ekta thappor dimu beddof", threadID);
   };

  if ((event.body.toLowerCase() == "Chayon") || (event.body.toLowerCase() == "চয়ন") || (event.body.toLowerCase() == "@UChayon Mohonto") || (event.body.toLowerCase() == "চয়ন")) {
...
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Chayon ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 chayon.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100077510251437\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01342478031", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Chayon ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস চয়ন আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Chayon ッ❤️ তাকে সবাই চয়ন নামে  চিনে🤙", threadID);
   };
...
   if ((event.body.toLowerCase() == "Sara") || (event.body.toLowerCase() == "sara")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস চয়ন এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "sadiya") || (event.body.toLowerCase() == "@Sadiya Afrin")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Niru") || (event.body.toLowerCase() == "@Misty Pagli")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস সবুজ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farjana") || (event.body.toLowerCase() == "farhana")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা আমার বস এর বউ এর নাম এটা..!🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Sinha") || (event.body.toLowerCase() == "sinha")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Chayon এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
...
     return api.sendMessage("️MY NAME IS °_>Pookie Sanda", threadID);
   };
...
   if ((event.body.toLowerCase() == "👀") || (event.body.toLowerCase() == "🙂")) {
     return api.sendMessage("️এই চাইয়া থাকস ক্যে কি কবি তুই কইলেই তো আমি কমু হ 🙂", threadID);
   };

   if ((event.body.toLowerCase() == "Kochu") || (event.body.toLowerCase() == "kochu")) {
     return api.sendMessage("️ কচু না দিয়ে চয়ন কে একটা বউ দে..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
...
     return api.sendMessage("valobasa valo nah 😪🥱", threadID);
   };
...
   if ((event.body.toLowerCase() == "Ami Chayon") || (event.body.toLowerCase() == "kire")) {
